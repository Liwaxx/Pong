...
public class GameManager : MonoBehaviour
{
    ...
    private Rigidbody2D player1Rigibody;

    //pemain 2
    public PlayerControl player2; //skrip
    private Rigidbody2D player2Rigibody;
    ...
    //Apakah debug window ditampikan ?
    ...
    private void Start()
    {
        player1Rigibody = player1.GetComponent<Rigidbody2D>();
        player2Rigibody = player2.GetComponent<Rigidbody2D>();
        ballRigibody = ball.GetComponent<Rigidbody2D>();
    ...
    void OnGUI()
    {
        ...
        if (isDebugWindowShown)
        {
            ...
            float ballMass = ballRigibody.mass;
            Vector2 ballVelocity = ballRigibody.velocity;
            float ballSpeed = ballRigibody.velocity.magnitude;
